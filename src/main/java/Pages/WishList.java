...
public class WishList extends Pages.PageBase {
    ...
    public void clickOnWishListTab(){clickOnElement(wishListTab);}
    public void clickOnCloseWishListMessage(){clickOnElement(closeWishListMessage);}
